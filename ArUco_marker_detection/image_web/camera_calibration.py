...
def calibrate(dirpath, prefix, image_format, square_size, width=9, height=6):
    ...
    if not images:
        raise ValueError("No images found. Check image_dir/prefix/image_format.")
...
if __name__ == '__main__':
    default_image_dir = os.path.join(os.path.dirname(__file__), "captures")
    parser = argparse.ArgumentParser(description='Camera calibration')
    parser.add_argument('--image_dir', type=str, default=default_image_dir, help='image directory path')
    parser.add_argument('--image_format', type=str, default='png', help='image format, png/jpg')
    parser.add_argument('--prefix', type=str, default='mobile_frame_', help='image prefix')
    parser.add_argument('--square_size', type=float, default=0.025, help='chessboard square size (meters)')
